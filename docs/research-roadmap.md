...
**Deliverable:** One document per topic in [`docs/research/`](research/README.md).
...
**Deliverable:** Three assessment documents in [`docs/feasibility/`](feasibility/README.md).
...
**Deliverable:** Decision document in [`docs/decision/`](decision/README.md).
